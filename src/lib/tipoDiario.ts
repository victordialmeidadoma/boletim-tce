...
export const TIPO_COLOR: Record<TipoDiario, string> = {
  ...
  FISCALIZACAO_ACOMPANHAMENTO:   "bg-amber-50 text-amber-700 border-amber-200",
  FISCALIZACAO:                  "bg-amber-50 text-amber-700 border-amber-200",
...
export const FIELDS_BY_TYPE: Record<TipoDiario, string[]> = {
  ...
  FISCALIZACAO_ACOMPANHAMENTO: ["entidade","descricao"],
  FISCALIZACAO:                ["entidade","descricao"],
...
export const CATEGORIAS: CategoriaDef[] = [
  ...
  },
  {
    ...
    subtipos: [
      ...
      { value: "FISCALIZACAO_ACOMPANHAMENTO",  label: "Acompanhamento" },
